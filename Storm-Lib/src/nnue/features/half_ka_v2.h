...
namespace Storm::NNUE {
  ...
  class HalfKAv2 {
    ...
    static SquareIndex orient(Color perspective, SquareIndex s);

    // Index of a feature for a given king position and another piece on some square
    static IndexType make_index(Color perspective, SquareIndex s, ColorPiece pc, SquareIndex ksq);
   ...
   public:
    ...
    static constexpr IndexType Dimensions =
        static_cast<IndexType>(SQUARE_MAX) * static_cast<IndexType>(PS_NB);
