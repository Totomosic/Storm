...
namespace Storm::NNUE::Layers
{
    ...
    static void affine_transform_non_ssse3(
      std::int32_t* output, const std::int8_t* weights, const std::int32_t* biases, const std::uint8_t* input)
    {
#if defined(USE_SSE2)
    ...
    public:
        ...
        static_assert(
          PaddedInputDimensions >= 128, "Something went wrong. This specialization should not have been chosen.");
        ...
        */
        static IndexType get_weight_index(IndexType i)
        {
            ...
            const IndexType idx = bigBlock * BigBlockSize + smallBlockRow * SmallBlockSize * NumOutputRegs +
...
#define vec_haddx4 Simd::m128_haddx4
            ...
            for (IndexType bigBlock = 0; bigBlock < NumBigBlocks; ++bigBlock)
            {
                ...
                {
                    const vec_t* weightvec = reinterpret_cast<const vec_t*>(
