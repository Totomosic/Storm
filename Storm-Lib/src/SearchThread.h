...
namespace Storm
{
    ...
    public:
        ...
        inline TranspositionTable& GetTranspositionTable()
        {
            return m_TranspositionTable;
        }

        inline const SearchSettings& GetSettings() const
        {
            return m_Settings;
        }

        inline void SetLogging(bool enabled)
        {
            m_EnableLogging = enabled;
        }

        inline void SetSettings(const SearchSettings& settings)
        {
            m_Settings = settings;
        }
