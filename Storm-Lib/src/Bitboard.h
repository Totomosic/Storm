...
namespace Storm
{
    ...
    inline constexpr BitBoard operator&(BitBoard left, BitBoard right)
    {
        return BitBoard(uint64_t(left) & uint64_t(right));
    }
    inline constexpr BitBoard operator|(BitBoard left, BitBoard right)
    {
        return BitBoard(uint64_t(left) | uint64_t(right));
    ...
    inline constexpr BitBoard operator>>(BitBoard left, int right)
    {
        return BitBoard(uint64_t(left) >> right);
    }
    inline constexpr BitBoard operator<<(BitBoard left, int right)
    {
        return BitBoard(uint64_t(left) << right);
    }
    inline constexpr BitBoard operator~(BitBoard left)
    {
        return BitBoard(~uint64_t(left));
    }
    ...
    inline constexpr BitBoard operator&(BitBoard left, SquareIndex right)
    {
        return left & SQUARE_BITBOARDS[right];
    }
    inline constexpr BitBoard operator|(BitBoard left, SquareIndex right)
    {
        return left | SQUARE_BITBOARDS[right];
    ...
    inline constexpr BitBoard operator&(SquareIndex left, BitBoard right)
    {
        return right & SQUARE_BITBOARDS[left];
    }
    inline constexpr BitBoard operator|(SquareIndex left, BitBoard right)
    {
        return right | SQUARE_BITBOARDS[left];
    ...
    inline constexpr BitBoard operator~(SquareIndex left)
    {
        return ~SQUARE_BITBOARDS[left];
    }

    inline constexpr BitBoard operator|(SquareIndex left, SquareIndex right)
    {
        return SQUARE_BITBOARDS[left] | SQUARE_BITBOARDS[right];
    }
